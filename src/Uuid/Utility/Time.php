...
final class Time
{
    ...
    /**
     * The maximum timestamp allowed in 100-nanosecond intervals since the
     * Gregorian epoch
     */
     ...
     * precision (i.e., 6).
     *
     * We specifically do not do any rounding here, since we don't want the time
     * to accidentally bump forward to the next second.
     */
