    ...
    StringIdentifierFactory
{
     ...
     * @throws InvalidArgument
     */
    public function createFromBytes(string $identifier): Ulid | MaxUlid | NilUlid
    {
     ...
     * @throws InvalidArgument
     */
    public function createFromHexadecimal(string $identifier): Ulid | MaxUlid | NilUlid
    {
     ...
     * @throws InvalidArgument
     */
    public function createFromInteger(int | string $identifier): Ulid | MaxUlid | NilUlid
    {
        if (
     ...
     * @throws InvalidArgument
     */
    public function createFromString(string $identifier): Ulid | MaxUlid | NilUlid
    {
