...
final class UuidV1Bench
{
    private UuidV1 $uuidWithBytes;
    private UuidV1 $uuidWithHex;
    private UuidV1 $uuidWithString;

    public function __construct()
    {
        $this->uuidWithBytes = new UuidV1("\x0a\xe0\xca\xc5\x2a\x40\x16\x5c\x99\xed\x3d\x33\x1b\x7c\xf7\x2a");
        $this->uuidWithHex = new UuidV1('0ae0cac52a40165c99ed3d331b7cf72a');
        $this->uuidWithString = new UuidV1('0ae0cac5-2a40-165c-99ed-3d331b7cf72a');
    }
