...
class UuidV8Test extends TestCase
{
    ...
    public static function compareToProvider(): array
    {
        return [
            ...
            'with same string UUID' => [self::UUID_V8_STRING, Comparison::Equal],
            'with same string UUID all caps' => [strtoupper(self::UUID_V8_STRING), Comparison::Equal],
            'with same hex UUID' => [self::UUID_V8_HEX, Comparison::Equal],
            'with same hex UUID all caps' => [strtoupper(self::UUID_V8_HEX), Comparison::Equal],
            'with same bytes UUID' => [self::UUID_V8_BYTES, Comparison::Equal],
            ...
            'with UuidV8 from string' => [new Uuid\UuidV8(self::UUID_V8_STRING), Comparison::Equal],
            'with UuidV8 from hex' => [new Uuid\UuidV8(self::UUID_V8_HEX), Comparison::Equal],
            'with UuidV8 from bytes' => [new Uuid\UuidV8(self::UUID_V8_BYTES), Comparison::Equal],
            'with MaxUuid' => [new Uuid\MaxUuid(), Comparison::LessThan],
            'with BinaryIdentifier class' => [new MockBinaryIdentifier(self::UUID_V8_BYTES), Comparison::Equal],
            'with Microsoft GUID' => [new Uuid\MicrosoftGuid(self::UUID_V8_STRING), Comparison::Equal],
            'with Ulid' => [new Ulid(self::UUID_V8_BYTES), Comparison::Equal],
        ];
    }
