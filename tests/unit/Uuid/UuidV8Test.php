...
{
    private const UUID_V8 = '27433d43-011d-8a6a-9161-1550863792c9';

    private Uuid\UuidV8 $uuid;

    protected function setUp(): void
    {
        $this->uuid = new Uuid\UuidV8(self::UUID_V8);
    }
    ...
    {
        $this->assertSame(self::UUID_V8, (string) $this->uuid);
    }
    ...
    public function testUnserialize(): void
    {
        ...
        $this->assertSame(self::UUID_V8, (string) $uuid);
    }

    public function testUnserializeFailsAssertionWhenUuidIsNotSet(): void
    {
        $serialized =
            'O:29:"Ramsey\\Identifier\\Uuid\\UuidV8":1:{s:3:"foo";s:36:"27433d43-011d-8a6a-9161-1550863792c9";}';
    ...
    {
        $serialized =
            'O:29:"Ramsey\\Identifier\\Uuid\\UuidV8":1:{s:4:"uuid";i:1234;}';
    ...
    public function testUnserializeFailsAssertionForInvalidVersionUuid(): void
    {
        ...
        $this->expectExceptionMessage(
            '\'uuid\' in serialized data is not a valid version 8 UUID: "27433d43-011d-9a6a-9161-1550863792c9"',
        );
    ...
    public function compareToProvider(): array
    {
        return [
            ...
            'with same string UUID' => [self::UUID_V8, 0],
            'with same string UUID all caps' => [strtoupper(self::UUID_V8), 0],
            ...
            'with same UuidV8' => [new Uuid\UuidV8(self::UUID_V8), 0],
    ...
    public function equalsProvider(): array
    {
        return [
            ...
            'with same string UUID' => [self::UUID_V8, true],
            'with same string UUID all caps' => [strtoupper(self::UUID_V8), true],
            ...
            'with same UuidV8' => [new Uuid\UuidV8(self::UUID_V8), true],
    ...
    {
        $this->assertSame(Version::Custom, $this->uuid->getVersion());
    }

    public function testJsonSerialize(): void
    {
        $this->assertSame('"' . self::UUID_V8 . '"', json_encode($this->uuid));
    }

    public function testToString(): void
    {
        $this->assertSame(self::UUID_V8, $this->uuid->toString());
    }
    ...
    {
        $this->assertSame(
            '27433d43011d8a6a91611550863792c9',
