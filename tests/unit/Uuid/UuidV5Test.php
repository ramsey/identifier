...
{
    private const UUID_V5 = '27433d43-011d-5a6a-9161-1550863792c9';

    private Uuid\UuidV5 $uuid;

    protected function setUp(): void
    {
        $this->uuid = new Uuid\UuidV5(self::UUID_V5);
    }
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('Invalid version 5 UUID: "27433d43-011d-5a6a-c161-1550863792c9"');

        new Uuid\UuidV5('27433d43-011d-5a6a-c161-1550863792c9');
    }
    ...
    {
        $this->assertSame(self::UUID_V5, (string) $this->uuid);
    }
    ...
    public function testUnserialize(): void
    {
        ...
        $this->assertSame(self::UUID_V5, (string) $uuid);
    }

    public function testUnserializeFailsAssertionWhenUuidIsNotSet(): void
    {
        $serialized =
            'O:29:"Ramsey\\Identifier\\Uuid\\UuidV5":1:{s:3:"foo";s:36:"27433d43-011d-5a6a-9161-1550863792c9";}';
    ...
    {
        $serialized =
            'O:29:"Ramsey\\Identifier\\Uuid\\UuidV5":1:{s:4:"uuid";i:1234;}';
    ...
    public function testUnserializeFailsAssertionForInvalidVersionUuid(): void
    {
        ...
        $this->expectExceptionMessage(
            '\'uuid\' in serialized data is not a valid version 5 UUID: "27433d43-011d-9a6a-9161-1550863792c9"',
        );
    ...
    public function compareToProvider(): array
    {
        return [
            ...
            'with same string UUID' => [self::UUID_V5, 0],
            'with same string UUID all caps' => [strtoupper(self::UUID_V5), 0],
            ...
            'with same UuidV5' => [new Uuid\UuidV5(self::UUID_V5), 0],
    ...
    public function equalsProvider(): array
    {
        return [
            ...
            'with same string UUID' => [self::UUID_V5, true],
            'with same string UUID all caps' => [strtoupper(self::UUID_V5), true],
            ...
            'with same UuidV5' => [new Uuid\UuidV5(self::UUID_V5), true],
    ...
    {
        $this->assertSame(Version::HashSha1, $this->uuid->getVersion());
    }

    public function testJsonSerialize(): void
    {
        $this->assertSame('"' . self::UUID_V5 . '"', json_encode($this->uuid));
    }

    public function testToString(): void
    {
        $this->assertSame(self::UUID_V5, $this->uuid->toString());
    }
    ...
    {
        $this->assertSame(
            '27433d43011d5a6a91611550863792c9',
    ...
    {
        $this->assertSame(
            '52189018260751234539370675194671108809',
            $this->uuid->toInteger(),
        );
    }
    ...
    {
        $this->assertSame(self::UUID_V5, $this->uuid->toRfc4122());
    }

    public function testToUrn(): void
    {
        $this->assertSame('urn:uuid:' . self::UUID_V5, $this->uuid->toUrn());
    }
}
