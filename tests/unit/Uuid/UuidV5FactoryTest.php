...
class UuidV5FactoryTest extends TestCase
{
    ...
    public function testCreateWithoutNamespaceThrowsException(): void
    {
        ...
        $this->expectExceptionMessage('When creating version 5 UUIDs, the namespace cannot be null');
    ...
    {
        $this->expectException(InvalidArgument::class);
        $this->expectExceptionMessage('When creating version 5 UUIDs, the name cannot be null');
