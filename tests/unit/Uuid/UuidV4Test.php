...
{
    private const UUID_V4 = '27433d43-011d-4a6a-9161-1550863792c9';

    private Uuid\UuidV4 $uuid;

    protected function setUp(): void
    {
        $this->uuid = new Uuid\UuidV4(self::UUID_V4);
    }
    ...
    public function testConstructorThrowsExceptionForInvalidUuid(): void
    {
        ...
        new Uuid\UuidV4('27433d43-011d-9a6a-9161-1550863792c9');
    }

    public function testConstructorThrowsExceptionForInvalidVariantUuid(): void
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessage('Invalid version 4 UUID: "27433d43-011d-4a6a-c161-1550863792c9"');

        new Uuid\UuidV4('27433d43-011d-4a6a-c161-1550863792c9');
    }
    ...
    {
        $this->assertSame(self::UUID_V4, (string) $this->uuid);
    }
    ...
    public function compareToProvider(): array
    {
        return [
            ...
            'with same string UUID' => [self::UUID_V4, 0],
            'with same string UUID all caps' => [strtoupper(self::UUID_V4), 0],
            ...
            'with same UuidV4' => [new Uuid\UuidV4(self::UUID_V4), 0],
    ...
    public function equalsProvider(): array
    {
        return [
            ...
            'with same string UUID' => [self::UUID_V4, true],
            'with same string UUID all caps' => [strtoupper(self::UUID_V4), true],
            ...
            'with same UuidV4' => [new Uuid\UuidV4(self::UUID_V4), true],
    ...
    {
        $this->assertSame(Version::Random, $this->uuid->getVersion());
    }

    public function testJsonSerialize(): void
    {
        $this->assertSame('"' . self::UUID_V4 . '"', json_encode($this->uuid));
    }

    public function testToString(): void
    {
        $this->assertSame(self::UUID_V4, $this->uuid->toString());
    }
    ...
    {
        $this->assertSame(
            '27433d43011d4a6a91611550863792c9',
    ...
    {
        $this->assertSame(
            '52189018260751158981506949280347689673',
            $this->uuid->toInteger(),
        );
    }
    ...
    {
        $this->assertSame(self::UUID_V4, $this->uuid->toRfc4122());
    }

    public function testToUrn(): void
    {
        $this->assertSame('urn:uuid:' . self::UUID_V4, $this->uuid->toUrn());
    }
}
