...
class UuidV7Test extends TestCase
{
    ...
    {
        $serialized =
            'O:29:"Ramsey\\Identifier\\Uuid\\UuidV7":1:{s:3:"foo";s:36:"017F22E2-79B0-7CC3-98C4-DC0C0C07398F";}';
    ...
    {
        $serialized =
            'O:29:"Ramsey\\Identifier\\Uuid\\UuidV7":1:{s:4:"uuid";i:1234;}';
    ...
    {
        $serialized =
            'O:29:"Ramsey\\Identifier\\Uuid\\UuidV7":1:{s:4:"uuid";s:0:"";}';
    ...
    public function testUnserializeFailsAssertionForInvalidVersionUuid(): void
    {
        ...
        $this->expectExceptionMessage(
            '\'uuid\' in serialized data is not a valid version 7 UUID: "a6a011d2-7433-9d43-9161-1550863792c9"',
        );
    ...
    {
        $this->assertSame(self::UUID_V7, $this->uuid->toRfc4122());
    }
